...
# --- 2. INICIALIZACIÓN DE CONTROLADOR DE COOKIES ---
...
if st.session_state["usuario"] is None:
    ...
    with tab_login:
        with st.form("form_login"):
            ...
            recordar_dispositivo = st.checkbox("Recordar en este dispositivo (Dispositivo Confiable)", value=True)
            ...
            if submit_login:
                try:
                    ...
                    if res.user:
                        ...
                        # Guardar cookie si seleccionó la opción de dispositivo confiable
                        if recordar_dispositivo and res.session:
                            max_age = 30 * 24 * 60 * 60  # 30 días en segundos
                            controller.set("supabase_refresh_token", res.session.refresh_token, max_age=max_age)
